...
- **アクション:**
  ...
  - **コンテキストの確認:** 直近の変更をレビューする際は、`git diff` だけでなく、必ず `CHANGELOG.md` や `docs/` 配下（実装計画やIssueなど）の変更履歴ドキュメントも確認し、全体の意図を把握すること。
...
**出力フォーマット:**
（`./.agents/rules/language-strategies.md` で定義された戦略に従ってください）
